...
// 	salt: string;
// 	ciphertext: string;
// 	constructor(iv: string, salt: string, ciphertext: string) {
// 		this.iv = iv;
// 		this.salt = salt;
...
export class Mcrypto {
	...
	words2ua(destUa: any, cryptowords: any) {
	...
	// Uint8ArrayToWordArray(ba: Uint8Array) {
	// 	const wa: number[] = [];
	...
	wordArrayToByteArray(wordArray: any, length: number) {
	...
	aes256Decrypt(key: string, encrypted: string) {
